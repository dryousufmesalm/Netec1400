...
2. Run `Install-AmarTradingTestCertificate.cmd` once and approve the Windows administrator prompt. It adds the included test certificates only to this VPS's trusted root and trusted publisher stores.
