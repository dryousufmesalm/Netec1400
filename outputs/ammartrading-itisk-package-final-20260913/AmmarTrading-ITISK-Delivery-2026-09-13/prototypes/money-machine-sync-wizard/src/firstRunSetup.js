import { accountNumber, discoveryId, isAccountEligible, rootPath, sourceCsv } from "./wizardState.js";
...
export function buildAutomaticSetupPayload({ vpsName, accounts, oneDriveRoot }) {
  return {
